const translations = {
  es: {
    ...
    noteHeading: "De EFFREY",
    noteGreeting: "Hola, gracias por estar aquí.",
    noteDesign: "Para mí, el diseño significa cuidado e intención.",
    noteReflection: "Si algo de lo que viste aquí, llamo su atencion,",
    noteInvitation: "¿Trabajamos juntos?",
  ...
  en: {
    ...
    noteHeading: "From EFFREY",
    noteGreeting: "Hi, thank you for being here.",
    noteDesign: "Design, to me, is care and intentionality.",
    noteReflection: "If something here stayed with you,",
    noteInvitation: "Shall we work together?",
...
function changeLanguage(language) {
  ...
  document.documentElement.lang = language === "es" ? "es-CO" : "en-US";
